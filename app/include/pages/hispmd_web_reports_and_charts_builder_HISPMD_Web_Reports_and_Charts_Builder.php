...
'googleLikeFields' => array(  ) ) );
			$pageArray = array( 'id' => 'HISPMD_Web_Reports_and_Charts_Builder',
'type' => 'dashboard',
'layoutId' => 'leftbar',
'disabled' => 0,
'default' => 1,
...
<head>
    ...
    <title>HISPMD Web Reports_and Charts Builder</title>
    <style>
        html, body {
            margin: 0;
            padding: 0;
...
<body>
<!--
    <div align="center"><h3>HISPMD Web Reports_and Charts Builder</h3></div>

-->
    <iframe         
        id="metabase-iframe"
        src="webreport.php" frameborder="0" marginheight="0" marginwidth="0" width="100%" height="100%"
