...
'googleLikeFields' => array(  ) ) );
			$pageArray = array( 'id' => 'hispmd_advanced_dashboard_data_visualizer',
'type' => 'dashboard',
'layoutId' => 'topbar',
'disabled' => 0,
'default' => 0,
...
<head>
    ...
    <title>HISPMD Advanced Visualizations Builder</title>
    <style>
...
src="index.php"
    ...
    <iframe
        ...
        src="../api/dash/index.php"
        allowtransparency
        title="HISPMD Advanced Chart and Dashboard Builder"
        loading="lazy">
    </iframe>
