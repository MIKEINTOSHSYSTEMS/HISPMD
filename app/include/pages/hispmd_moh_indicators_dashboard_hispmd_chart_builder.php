...
'googleLikeFields' => array(  ) ) );
			$pageArray = array( 'id' => 'hispmd_chart_builder',
'type' => 'dashboard',
'layoutId' => 'leftbar',
'disabled' => 0,
'default' => 0,
...
'label' => array( 'text' => '<!DOCTYPE html><html lang="en"><head>    <meta charset="UTF-8">    <meta name="viewport" content="width=device-width, initial-scale=1.0">    <title>HISPMD Chart Builder</title>    <style>        iframe {            border: none;            width: 100%;            height: 111vh;        }        @media (max-width: 768px) {            iframe {                height: 80vh; /* Adjust height for smaller screens */            }        }        @media (max-width: 480px) {            iframe {                height: 70vh; /* Further adjust for mobile devices */            }        }    </style></head><body>    <iframe        id="hispmd-iframe"        src="../api/chart/chartbuilder.php"        allowtransparency></iframe><!--If any Questions Please Contact https://github.com/MIKEINTOSHSYSTEMS --></body></html>',
'type' => 0 ),
'editedByRte' => false ),
