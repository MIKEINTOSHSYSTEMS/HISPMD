...
class tDAL
{
	...
	var $tblhispmdathispmdmerqconsultancyo_public_eidm_hc;
	var $tblhispmdathispmdmerqconsultancyo_public_eidm_settings;
	...
	var $tblhispmdathispmdmerqconsultancyo_public_moh_indicators_target;
	...
	function FillTablesList()
	{
		...
		$this->lstTables[] = array("name" => "eidm_hc", "varname" => "hispmdathispmdmerqconsultancyo_public_eidm_hc", "altvarname" => "eidm_hc", "connId" => "hispmdathispmdmerqconsultancyo", "schema" => "public", "connName" => "hisp_md at hispmd.merqconsulta");
		$this->lstTables[] = array("name" => "eidm_settings", "varname" => "hispmdathispmdmerqconsultancyo_public_eidm_settings", "altvarname" => "eidm_settings", "connId" => "hispmdathispmdmerqconsultancyo", "schema" => "public", "connName" => "hisp_md at hispmd.merqconsulta");
		...
		$this->lstTables[] = array("name" => "moh_indicators_target", "varname" => "hispmdathispmdmerqconsultancyo_public_moh_indicators_target", "altvarname" => "moh_indicators_target", "connId" => "hispmdathispmdmerqconsultancyo", "schema" => "public", "connName" => "hisp_md at hispmd.merqconsulta");
