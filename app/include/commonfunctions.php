...
function checkTableName($shortTName )
{
	...
	if ("dhis2_organisation_unit" == $shortTName )
		return true;
	if ("dhis2_analytics_chart" == $shortTName )
		return true;
	if ("dhis2_analytics_report" == $shortTName )
		return true;
	...
	if ("dhis2_reportingrate_chart" == $shortTName )
		return true;
	if ("dhis2_reportingrates" == $shortTName )
		return true;
	...
	if ("dhis2_data_elements" == $shortTName )
		return true;
	if ("dhis_2_reporting_rates_chart" == $shortTName )
		return true;
	return false;
}
...
function GetTablesList($pdfMode = false)
{
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("DHIS2_Analytics Chart");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="DHIS2_Analytics Chart";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("DHIS2_Analytics Report");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("DHIS2_Reports");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("DHIS2_Datasets");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("public.mfr_facilities_register_report");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("public.mfr_facilities_register_chart");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("Indicators_Dashboard");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("DHIS2_ReportingRates");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("DHIS2_AnalyticsReport");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("DHIS_2_Reporting_Rates_Chart");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="DHIS_2_Reporting_Rates_Chart";
	}
	return $arr;
}
...
function GetChartType($shorttable)
{
	...
	if($shorttable=="dhis2_reportingrate_chart")
		return "2DColumn";
	if($shorttable=="dhis_2_reporting_rates_chart")
		return "2DColumn";
	return "";
}
...
//	default permissions
	...
	if( $table=="DHIS_2_Reporting_Rates_Chart" )
	{
//	default permissions
		return "S".$extraPerm;
	}
