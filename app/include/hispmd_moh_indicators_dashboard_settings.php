...
$tdatahispmd_moh_indicators_dashboard[".pagesByType"] = my_json_decode( "{\"dashboard\":[\"hispmd_moh_dahsboard\",\"aio_moh_indicators_dashboard\",\"hispmd_dashboard\",\"hispmd_data_quality_dashboard\",\"hispmd_data_use_dashboard\",\"hispmd_digital_health_dashboard\",\"hispmd_his_governance_dashboard\",\"hispmd_ir_pathway_dashboard\",\"hispmd_other_additional_dashboard\"]}" );
$tdatahispmd_moh_indicators_dashboard[".originalPagesByType"] = $tdatahispmd_moh_indicators_dashboard[".pagesByType"];
$tdatahispmd_moh_indicators_dashboard[".pages"] = types2pages( my_json_decode( "{\"dashboard\":[\"hispmd_moh_dahsboard\",\"aio_moh_indicators_dashboard\",\"hispmd_dashboard\",\"hispmd_data_quality_dashboard\",\"hispmd_data_use_dashboard\",\"hispmd_digital_health_dashboard\",\"hispmd_his_governance_dashboard\",\"hispmd_ir_pathway_dashboard\",\"hispmd_other_additional_dashboard\"]}" ) );
