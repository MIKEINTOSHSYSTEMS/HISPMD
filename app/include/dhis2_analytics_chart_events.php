 ...
 */
 ...
 class eventclass_dhis2_analytics_chart  extends eventsBase
{
...
// apply search and order parameters NEW
if( !$command->order ) {
$command->order[] = array("column" => "Period", "dir"=>"ASC" );
}

// Apply search and filter parameters
$rs = $dataSource->filterResult($rs, $command->filter);

// Apply data record results NEW
