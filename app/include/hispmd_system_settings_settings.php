...
$tdatahispmd_system_settings[".pagesByType"] = my_json_decode( "{\"export\":[\"export\"],\"list\":[\"list\",\"databases\",\"mb_databases\"],\"print\":[\"print\"],\"search\":[\"search\"],\"view\":[\"view\"]}" );
$tdatahispmd_system_settings[".originalPagesByType"] = $tdatahispmd_system_settings[".pagesByType"];
$tdatahispmd_system_settings[".pages"] = types2pages( my_json_decode( "{\"export\":[\"export\"],\"list\":[\"list\",\"databases\",\"mb_databases\"],\"print\":[\"print\"],\"search\":[\"search\"],\"view\":[\"view\"]}" ) );
