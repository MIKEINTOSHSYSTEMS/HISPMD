...
require_once("include/mfr_dashboard_report_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "MFR_Dashboard_Report" );
