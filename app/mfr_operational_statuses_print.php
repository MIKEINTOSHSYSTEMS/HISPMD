...
require_once("include/mfr_operational_statuses_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "MFR_Operational_Statuses" );
