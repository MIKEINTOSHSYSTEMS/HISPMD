...
require_once("include/hispmd_prism_data_forms_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "hispmd_prism_data_forms" );
