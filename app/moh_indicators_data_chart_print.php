...
require_once("include/moh_indicators_data_chart_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "MOH_Indicators_data_Chart" );
