...
require_once("include/dhis2_reportingrate_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "DHIS2_ReportingRate" );
