...
require_once("include/dhis2_orgunits_distribution_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "DHIS2_OrgUnits_Distribution" );
