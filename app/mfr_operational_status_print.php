...
require_once("include/mfr_operational_status_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.mfr_operational_status" );
