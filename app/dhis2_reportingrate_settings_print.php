...
require_once("include/dhis2_reportingrate_settings_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.dhis2_reportingrate_settings" );
