	...
	*/
	...
	protected static function _fillTablesList( $conn )
	{
		...
		if( "hispmdathispmdmerqconsultancyo" == $conn->connId )
		{
			...
			$dalTables[$conn->connId][] = array("name" => "MFR_Reporting", "varname" => "hispmdathispmdmerqconsultancyo__MFR_Reporting", "altvarname" => "MFR_Reporting", "connId" => "hispmdathispmdmerqconsultancyo", "schema" => "", "connName" => "hisp_md at hispmd.merqconsulta");
