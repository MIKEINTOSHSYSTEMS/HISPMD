	...
	*/
	...
	protected static function _fillTablesList( $conn )
	{
		...
		if( "hispmdathispmdmerqconsultancyo" == $conn->connId )
		{
			...
			$dalTables[$conn->connId][] = array("name" => "dhis2_reporting_rates", "varname" => "hispmdathispmdmerqconsultancyo_public_dhis2_reporting_rates", "altvarname" => "dhis2_reporting_rates", "connId" => "hispmdathispmdmerqconsultancyo", "schema" => "public", "connName" => "hisp_md at hispmd.merqconsulta");
			$dalTables[$conn->connId][] = array("name" => "dhis2_reportingrate_settings", "varname" => "hispmdathispmdmerqconsultancyo_public_dhis2_reportingrate_settings", "altvarname" => "dhis2_reportingrate_settings", "connId" => "hispmdathispmdmerqconsultancyo", "schema" => "public", "connName" => "hisp_md at hispmd.merqconsulta");
			...
			$dalTables[$conn->connId][] = array("name" => "eidm_hc", "varname" => "hispmdathispmdmerqconsultancyo_public_eidm_hc", "altvarname" => "eidm_hc", "connId" => "hispmdathispmdmerqconsultancyo", "schema" => "public", "connName" => "hisp_md at hispmd.merqconsulta");
			$dalTables[$conn->connId][] = array("name" => "eidm_settings", "varname" => "hispmdathispmdmerqconsultancyo_public_eidm_settings", "altvarname" => "eidm_settings", "connId" => "hispmdathispmdmerqconsultancyo", "schema" => "public", "connName" => "hisp_md at hispmd.merqconsulta");
			...
			$dalTables[$conn->connId][] = array("name" => "moh_indicators_target", "varname" => "hispmdathispmdmerqconsultancyo_public_moh_indicators_target", "altvarname" => "moh_indicators_target", "connId" => "hispmdathispmdmerqconsultancyo", "schema" => "public", "connName" => "hisp_md at hispmd.merqconsulta");
