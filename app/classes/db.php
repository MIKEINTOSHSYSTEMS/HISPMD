	...
	*/
	...
	protected static function _fillTablesList( $conn )
	{
		...
		if( "hispmdathispmdmerqconsultancyo" == $conn->connId )
		{
			...
			$dalTables[$conn->connId][] = array("name" => "DHIS2_Periods", "varname" => "hispmdathispmdmerqconsultancyo__DHIS2_Periods", "altvarname" => "DHIS2_Periods", "connId" => "hispmdathispmdmerqconsultancyo", "schema" => "", "connName" => "hisp_md at hispmd.merqconsulta");
			...
			$dalTables[$conn->connId][] = array("name" => "DigitalHealthApps", "varname" => "hispmdathispmdmerqconsultancyo__DigitalHealthApps", "altvarname" => "DigitalHealthApps", "connId" => "hispmdathispmdmerqconsultancyo", "schema" => "", "connName" => "hisp_md at hispmd.merqconsulta");
			$dalTables[$conn->connId][] = array("name" => "FinancialResources", "varname" => "hispmdathispmdmerqconsultancyo__FinancialResources", "altvarname" => "FinancialResources", "connId" => "hispmdathispmdmerqconsultancyo", "schema" => "", "connName" => "hisp_md at hispmd.merqconsulta");
			$dalTables[$conn->connId][] = array("name" => "HealthFacilities", "varname" => "hispmdathispmdmerqconsultancyo__HealthFacilities", "altvarname" => "HealthFacilities", "connId" => "hispmdathispmdmerqconsultancyo", "schema" => "", "connName" => "hisp_md at hispmd.merqconsulta");
			$dalTables[$conn->connId][] = array("name" => "HealthUnits", "varname" => "hispmdathispmdmerqconsultancyo__HealthUnits", "altvarname" => "HealthUnits", "connId" => "hispmdathispmdmerqconsultancyo", "schema" => "", "connName" => "hisp_md at hispmd.merqconsulta");
			$dalTables[$conn->connId][] = array("name" => "HISGovernance", "varname" => "hispmdathispmdmerqconsultancyo__HISGovernance", "altvarname" => "HISGovernance", "connId" => "hispmdathispmdmerqconsultancyo", "schema" => "", "connName" => "hisp_md at hispmd.merqconsulta");
			$dalTables[$conn->connId][] = array("name" => "HISPartners", "varname" => "hispmdathispmdmerqconsultancyo__HISPartners", "altvarname" => "HISPartners", "connId" => "hispmdathispmdmerqconsultancyo", "schema" => "", "connName" => "hisp_md at hispmd.merqconsulta");
			$dalTables[$conn->connId][] = array("name" => "hispmd_uggroups", "varname" => "hispmdathispmdmerqconsultancyo__hispmd_uggroups", "altvarname" => "hispmd_uggroups", "connId" => "hispmdathispmdmerqconsultancyo", "schema" => "", "connName" => "hisp_md at hispmd.merqconsulta");
			$dalTables[$conn->connId][] = array("name" => "hispmd_ugmembers", "varname" => "hispmdathispmdmerqconsultancyo__hispmd_ugmembers", "altvarname" => "hispmd_ugmembers", "connId" => "hispmdathispmdmerqconsultancyo", "schema" => "", "connName" => "hisp_md at hispmd.merqconsulta");
			$dalTables[$conn->connId][] = array("name" => "hispmd_ugrights", "varname" => "hispmdathispmdmerqconsultancyo__hispmd_ugrights", "altvarname" => "hispmd_ugrights", "connId" => "hispmdathispmdmerqconsultancyo", "schema" => "", "connName" => "hisp_md at hispmd.merqconsulta");
			$dalTables[$conn->connId][] = array("name" => "hispmd_users", "varname" => "hispmdathispmdmerqconsultancyo__hispmd_users", "altvarname" => "hispmd_users", "connId" => "hispmdathispmdmerqconsultancyo", "schema" => "", "connName" => "hisp_md at hispmd.merqconsulta");
			$dalTables[$conn->connId][] = array("name" => "MFR_Dashboard_Reports", "varname" => "hispmdathispmdmerqconsultancyo__MFR_Dashboard_Reports", "altvarname" => "MFR_Dashboard_Reports", "connId" => "hispmdathispmdmerqconsultancyo", "schema" => "", "connName" => "hisp_md at hispmd.merqconsulta");
			$dalTables[$conn->connId][] = array("name" => "MFR_Facilities", "varname" => "hispmdathispmdmerqconsultancyo__MFR_Facilities", "altvarname" => "MFR_Facilities", "connId" => "hispmdathispmdmerqconsultancyo", "schema" => "", "connName" => "hisp_md at hispmd.merqconsulta");
			$dalTables[$conn->connId][] = array("name" => "MFR_Operational_Status", "varname" => "hispmdathispmdmerqconsultancyo__MFR_Operational_Status", "altvarname" => "MFR_Operational_Status", "connId" => "hispmdathispmdmerqconsultancyo", "schema" => "", "connName" => "hisp_md at hispmd.merqconsulta");
			$dalTables[$conn->connId][] = array("name" => "MFR_Region", "varname" => "hispmdathispmdmerqconsultancyo__MFR_Region", "altvarname" => "MFR_Region", "connId" => "hispmdathispmdmerqconsultancyo", "schema" => "", "connName" => "hisp_md at hispmd.merqconsulta");
			$dalTables[$conn->connId][] = array("name" => "MFR_Woreda", "varname" => "hispmdathispmdmerqconsultancyo__MFR_Woreda", "altvarname" => "MFR_Woreda", "connId" => "hispmdathispmdmerqconsultancyo", "schema" => "", "connName" => "hisp_md at hispmd.merqconsulta");
			$dalTables[$conn->connId][] = array("name" => "MFR_Zone", "varname" => "hispmdathispmdmerqconsultancyo__MFR_Zone", "altvarname" => "MFR_Zone", "connId" => "hispmdathispmdmerqconsultancyo", "schema" => "", "connName" => "hisp_md at hispmd.merqconsulta");
