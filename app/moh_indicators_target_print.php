...
require_once("include/moh_indicators_target_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.moh_indicators_target" );
