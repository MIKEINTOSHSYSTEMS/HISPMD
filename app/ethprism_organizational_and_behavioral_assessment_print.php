...
require_once("include/ethprism_organizational_and_behavioral_assessment_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.ethprism_organizational_and_behavioral_assessment" );
