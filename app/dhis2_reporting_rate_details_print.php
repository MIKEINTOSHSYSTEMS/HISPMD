...
require_once("include/dhis2_reporting_rate_details_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "DHIS2_Reporting_Rate_Details" );
