...
require_once("include/moh_indicator_data_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.moh_indicator_data" );
