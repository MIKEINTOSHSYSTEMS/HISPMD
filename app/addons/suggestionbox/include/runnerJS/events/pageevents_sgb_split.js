...
Runner.pages.PageSettings.addPageEvent('sgb_split', Runner.pages.constants.PAGE_LIST, "afterPageReady", function(pageObj, proxy, pageid, inlineRow, inlineObject, row ) {
...
Runner.pages.PageSettings.addPageEvent('sgb_split', Runner.pages.constants.PAGE_ADD, "afterPageReady", function(pageObj, proxy, pageid, inlineRow, inlineObject, row ) {
...
Runner.pages.PageSettings.addPageEvent('sgb_split', Runner.pages.constants.PAGE_EDIT, "afterPageReady", function(pageObj, proxy, pageid, inlineRow, inlineObject, row ) {
