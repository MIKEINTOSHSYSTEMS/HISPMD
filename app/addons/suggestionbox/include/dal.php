...
class tDAL
{
	var $tblproject_at_localhost__sgb_blockedip;
	var $tblproject_at_localhost__sgb_categories;
	var $tblproject_at_localhost__sgb_comments;
	var $tblproject_at_localhost__sgb_notify;
	var $tblproject_at_localhost__sgb_status;
	var $tblproject_at_localhost__sgb_suggestions;
	var $tblproject_at_localhost__sgb_users;
	var $tblproject_at_localhost__sgb_votes;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "sgb_blockedip", "varname" => "project_at_localhost__sgb_blockedip", "altvarname" => "sgb_blockedip", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
		$this->lstTables[] = array("name" => "sgb_categories", "varname" => "project_at_localhost__sgb_categories", "altvarname" => "sgb_categories", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
		$this->lstTables[] = array("name" => "sgb_comments", "varname" => "project_at_localhost__sgb_comments", "altvarname" => "sgb_comments", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
		$this->lstTables[] = array("name" => "sgb_notify", "varname" => "project_at_localhost__sgb_notify", "altvarname" => "sgb_notify", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
		$this->lstTables[] = array("name" => "sgb_status", "varname" => "project_at_localhost__sgb_status", "altvarname" => "sgb_status", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
		$this->lstTables[] = array("name" => "sgb_suggestions", "varname" => "project_at_localhost__sgb_suggestions", "altvarname" => "sgb_suggestions", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
		$this->lstTables[] = array("name" => "sgb_users", "varname" => "project_at_localhost__sgb_users", "altvarname" => "sgb_users", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
		$this->lstTables[] = array("name" => "sgb_votes", "varname" => "project_at_localhost__sgb_votes", "altvarname" => "sgb_votes", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
	}
