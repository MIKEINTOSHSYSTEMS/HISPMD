...
//		return $this->getTableData(".showSimpleSearchOptions");
	...
	public static function getForLogin()
	{
		return !!Security::dbProvider()
			? new ProjectSettings("sgb_users", PAGE_LIST)
			: null;
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "sgb_users" ] = array( "url" => "sgb_users", "type" => 0 );
	$projectEntitiesReverse[ "sgb_users" ] = "sgb_users";
	$projectEntities[ "sgb_suggestions" ] = array( "url" => "sgb_suggestions", "type" => 0 );
	$projectEntitiesReverse[ "sgb_suggestions" ] = "sgb_suggestions";
	$projectEntities[ "sgb_status" ] = array( "url" => "sgb_status", "type" => 0 );
	$projectEntitiesReverse[ "sgb_status" ] = "sgb_status";
	$projectEntities[ "sgb_categories" ] = array( "url" => "sgb_categories", "type" => 0 );
	$projectEntitiesReverse[ "sgb_categories" ] = "sgb_categories";
	$projectEntities[ "sgb_votes" ] = array( "url" => "sgb_votes", "type" => 0 );
	$projectEntitiesReverse[ "sgb_votes" ] = "sgb_votes";
	$projectEntities[ "sgb_comments" ] = array( "url" => "sgb_comments", "type" => 0 );
	$projectEntitiesReverse[ "sgb_comments" ] = "sgb_comments";
	$projectEntities[ "sgb_admin_suggestions" ] = array( "url" => "sgb_admin_suggestions", "type" => 1 );
	$projectEntitiesReverse[ "sgb_admin_suggestions" ] = "sgb_admin_suggestions";
	$projectEntities[ "sgb_admin_comments" ] = array( "url" => "sgb_admin_comments", "type" => 1 );
	$projectEntitiesReverse[ "sgb_admin_comments" ] = "sgb_admin_comments";
	$projectEntities[ "sgb_notify" ] = array( "url" => "sgb_notify", "type" => 0 );
	$projectEntitiesReverse[ "sgb_notify" ] = "sgb_notify";
	$projectEntities[ "sgb_users_suggestions" ] = array( "url" => "sgb_users_suggestions", "type" => 1 );
	$projectEntitiesReverse[ "sgb_users_suggestions" ] = "sgb_users_suggestions";
	$projectEntities[ "sgb_users_comments" ] = array( "url" => "sgb_users_comments", "type" => 1 );
	$projectEntitiesReverse[ "sgb_users_comments" ] = "sgb_users_comments";
	$projectEntities[ "contributor" ] = array( "url" => "contributor", "type" => 4 );
	$projectEntitiesReverse[ "contributor" ] = "contributor";
	$projectEntities[ "sgb_merge" ] = array( "url" => "sgb_merge", "type" => 1 );
	$projectEntitiesReverse[ "sgb_merge" ] = "sgb_merge";
	$projectEntities[ "sgb_split" ] = array( "url" => "sgb_split", "type" => 1 );
	$projectEntitiesReverse[ "sgb_split" ] = "sgb_split";
	$projectEntities[ "sgb_blockedip" ] = array( "url" => "sgb_blockedip", "type" => 0 );
	$projectEntitiesReverse[ "sgb_blockedip" ] = "sgb_blockedip";
}
