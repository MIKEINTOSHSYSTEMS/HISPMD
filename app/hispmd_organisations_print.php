...
require_once("include/hispmd_organisations_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.hispmd_organisations" );
