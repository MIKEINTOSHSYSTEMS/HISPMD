...
require_once("include/hispmd_system_settings_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "hispmd_system_settings" );
