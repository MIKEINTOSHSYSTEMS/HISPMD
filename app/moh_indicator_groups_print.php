...
require_once("include/moh_indicator_groups_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.moh_indicator_groups" );
