...
require_once("include/dhis2_orgunit_distributions_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "DHIS2_OrgUnit_Distributions" );
