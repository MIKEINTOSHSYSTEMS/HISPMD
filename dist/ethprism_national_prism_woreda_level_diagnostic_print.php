...
require_once("include/ethprism_national_prism_woreda_level_diagnostic_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.ethprism_national_prism_woreda_level_diagnostic" );
