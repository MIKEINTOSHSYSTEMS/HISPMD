...
require_once("include/ethprism_additional_organizational_and_behavioral_assessment_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.ethprism_additional_organizational_and_behavioral_assessment" );
