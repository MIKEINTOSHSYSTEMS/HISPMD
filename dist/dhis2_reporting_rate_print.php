...
require_once("include/dhis2_reporting_rate_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "DHIS2_Reporting_Rate" );
