...
require_once("include/dhis2_organisation_unit_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "DHIS2_Organisation_Unit" );
