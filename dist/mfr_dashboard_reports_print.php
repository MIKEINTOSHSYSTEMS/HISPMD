...
require_once("include/mfr_dashboard_reports_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.mfr_dashboard_reports" );
