...
require_once("include/dhis2_orgunit_regions_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "DHIS2_OrgUnit_Regions" );
