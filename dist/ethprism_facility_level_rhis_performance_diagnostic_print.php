...
require_once("include/ethprism_facility_level_rhis_performance_diagnostic_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.ethprism_facility_level_rhis_performance_diagnostic" );
