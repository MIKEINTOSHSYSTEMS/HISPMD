...
require_once("include/healthfacilities_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.healthfacilities" );
