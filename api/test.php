...
$apiEndpoints = [
    ...
    'Indicators' => 'app/api/v1.php?apikey=$2y$10$vdzwxfOVSYoy9xMYgISLjuNfKYxGCa4RpQRTTm5kU3qcMDxupd72C&table=moh_indicators&action=list',
    'Data Sources' => 'app/api/v1.php?apikey=$2y$10$vdzwxfOVSYoy9xMYgISLjuNfKYxGCa4RpQRTTm5kU3qcMDxupd72C&table=moh_datasources&action=list',
...
//    'Facility Performance Data' => 'api/v1/facility_performance',
//    'Quality Indicators' => 'api/v1/quality_indicators',
//    'Geospatial Data' => 'api/v1/geospatial',
//    'User Analytics' => 'api/v1/user_analytics'
];
...
<body>
            ...
            <div class="api-dashboard" id="dashboardSection">
                ...
                <div class="api-tabs">
                    <?php foreach (array_slice($apiEndpoints, 0, 6) as $tabName => $endpoint): ?>
                        <div class="api-tab <?= $tabName === 'Main HIS Indicator Data' ? 'active' : '' ?>" data-tab="<?= strtolower(str_replace(' ', '-', $tabName)) ?>">
                            <?= $tabName ?>
                    ...
                    <div class="api-content <?= $tabName === 'Main HIS Indicator Data' ? 'active' : '' ?>" id="<?= strtolower(str_replace(' ', '-', $tabName)) ?>-content">
                        <div class="api-endpoint">
                            <div class="endpoint-header">
                                ...
                                <span class="endpoint-url"><?= $apiBaseUrl . $endpoint ?></span>
                            </div>
                            ...
                            <div class="endpoint-actions">
                                <button class="endpoint-btn btn-try" data-endpoint="<?= $endpoint ?>"><i class="fas fa-play"></i> Try it out</button>
    ...
    <script>
        ...
        // Try It Out Button - Now makes actual API calls
