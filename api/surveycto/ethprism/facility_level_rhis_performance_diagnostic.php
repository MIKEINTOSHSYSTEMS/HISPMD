...
function JSON_to_table($json_var, $tblName = 'ethprism_facility_level_rhis_performance_diagnostic') {
...
// Example usage
//dup_t_module_ii_facility_level_rhis_performance_diagnostic_tool
$url = 'https://ethiopiaprism.surveycto.com/api/v2/forms/data/wide/json/dup_t_module_ii_facility_level_rhis_performance_diagnostic_tool?date=2024&r=approved|rejected';
