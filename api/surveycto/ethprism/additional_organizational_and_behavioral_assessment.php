...
function JSON_to_table($json_var, $tblName = 'ethprism_additional_organizational_and_behavioral_assessment') {
...
// Example usage
//dup_t_module_vi_organizational_and_behavioral_assessment_tool_obat__endline
$url = 'https://ethiopiaprism.surveycto.com/api/v2/forms/data/wide/json/dup_t_module_vi_organizational_and_behavioral_assessment_tool_obat__endline?date=2024&r=approved|rejected';
