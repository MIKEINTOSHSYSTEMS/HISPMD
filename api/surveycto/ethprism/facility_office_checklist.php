...
function JSON_to_table($json_var, $tblName = 'ethprism_facility_office_checklist') {
    ...
    // Establish a new connection using pg_connect
    ...
    // Create table query
    $createTableQuery = "CREATE TABLE \"$tblName\" ($columnDefinitions)";
...
// dup_t_module_v_facilityoffice_checklist
