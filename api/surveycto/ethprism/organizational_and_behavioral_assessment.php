...
function JSON_to_table($json_var, $tblName = 'ethprism_organizational_and_behavioral_assessment') {
...
// Example usage
//mod_vi_obat
$url = 'https://ethiopiaprism.surveycto.com/api/v2/forms/data/wide/json/mod_vi_obat?date=2024&r=approved|rejected';
