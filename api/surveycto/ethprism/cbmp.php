...
function JSON_to_table($json_var, $tblName = 'ethprism_mod_vi_obat_cbmp') {
...
//mod_vi_obat_cbmp
$url = 'https://ethiopiaprism.surveycto.com/api/v2/forms/data/wide/json/mod_vi_obat_cbmp?date=2024&r=approved|rejected';
