    ...
    if (!_.ui) {
      ...
      (function ($) {
        var Y7 = function (a, b) {
          ...
          f8 = function (a, b, c, d) {
            ...
            d != e8(a, c) &&
              ...
              d
                ? ((a = d8(a, 1)),
                  c.insertBefore(b.f.Ac("DIV", a), c.firstChild || null))
            ...
            if (c)
              for (var d = c.firstChild, e; d && d.parentNode == c; ) {
                ...
                if (1 == d.nodeType) {
                  var f = a.WG(d);
                  f &&
                    ((f.Ed = d), b.isEnabled() || f.Cj(!1), b.hc(f), f.As(d));
                } else
          ...
          ota = function (a, b) {
            ...
            b
              ? c
                  .va(d, "focus", a.UM)
                  .va(d, "blur", a.TM)
                  .va(a.Xl || (a.Xl = new $.Np(n8(a))), "key", a.no)
              : c
                  .fc(d, "focus", a.UM)
                  .fc(d, "blur", a.TM)
                  .fc(a.Xl || (a.Xl = new $.Np(n8(a))), "key", a.no);
          },
          pta = function (a, b) {
            var c = b.Ya();
            c = c.id || (c.id = b.ny());
          ...
          uta = function (a, b) {
            $.Gy(a)
              ? ($.Rj(b, "anychart-submenu-arrow-rtl"), $.ef(b, "◄"))
              : ($.Tj(b, "anychart-submenu-arrow-rtl"), $.ef(b, "►"));
          },
          J8 = function (a, b, c, d) {
          ...
          K8 = function (a) {
            a.Ul
              ? a.WM && a.Ul.getParent() != a && a.Ul.el(a)
              : M8(a, new z8(a.f));
            a.Ul.Ya() || a.Ul.Ac();
            return a.Ul;
          },
          ...
          Ata = function (a, b) {
            ...
            if (
              b != c.Oe() &&
              (b && (c.wf || c.Rd(a.b), c.Vn(-1)), c.Ji(b), b)
            ) {
              c = new G8(a.Ya(), 12, !1);
              var e = P8(a),
                f = e.Ya();
          ...
          P8 = function (a) {
            if (a.Jl) a.MK && a.Jl.getParent() != a && a.Jl.el(a);
            else {
              var b = a.P ? R8.Hd() : void 0;
              b = new B8(a.f, b);
              var c = a.Jl;
              b != c &&
                (c && (a.Nl(), a.wf && Q8(a, c, !1)),
                (a.Jl = b),
                (a.MK = !1),
                b &&
                  (b.el(a),
          ...
          Fta = function (a, b, c) {
            ...
            for (e = 0; e < d.length; e++) {
              ...
              c.text
                ? c.subMenu
                  ? ((f = new O8(f, a.ba)),
                    h.length && $.BD(f, h.join(" ")),
                    $.da(c.enabled) && f.Cj(c.enabled),
                    Fta(a, f, c.subMenu),
                    W8(b, f),
                    $.n(c.iconClass) && Gta(f, c.iconClass))
                  : (c.href &&
                      ((f = $.Oe(
                        "A",
            ...
            if (c) {
              ...
              b
                ? d
                  ...
                  : ((d = $.Oe("I", b)), $.By(d, "hidden", !0), $.Xe(c, d, 0))
                : d && $.Rf(d, !1);
            }
          },
          R8 = function (a) {
          ...
          a9 = function (a, b) {
            var c = a.b;
            b != c &&
              (c && (a.Bl(!1), a.wf && c9(a, c, !1), delete a.b),
              a.wf && $.By(a.Ed, "haspopup", !!b),
              b &&
                ((a.b = b),
                b.el(a),
                b.Ji(!1),
          ...
          w9 = function (a, b, c) {
            b &&
              ("function" == typeof a.DU
                ? a.DU(b, c)
                : "function" == typeof b.mJ && b.mJ(c));
          },
          y9 = function () {
            $.Dy.call(this);
            this.b = null;
        ...
        $.Jy.prototype.ol = $.ca(21, function (a) {
          ...
          d == a &&
            ((this.AH = !0), (a = this.Ya()), $.Tj(a, "label-input-label"));
        ...
        $.g.Wka = function () {
          if (this.enabled) {
            var a = (0, $.Qn)() - this.o;
            0 < a && a < 0.8 * this.f
              ? (this.Zv = this.b.setTimeout(this.i, this.f - a))
        ...
        $.g.start = function () {
          this.enabled = !0;
          this.Zv ||
            ((this.Zv = this.b.setTimeout(this.i, this.f)),
            (this.o = (0, $.Qn)()));
        };
        $.g.stop = function () {
          this.enabled = !1;
        ...
        $.g.Wk = function (a, b) {
          ...
          $.Nj(b, "anychart-option") &&
            (a.hn(16, !0), a && b && f8(this, a, b, !0));
        ...
        $.g.wM = function () {
          ...
          return $.A(a)
            ? ((a = (0, $.Wa)(a, function (a) {
                return $.bf(a) &&
                  ($.Nj(a, "anychart-menuitem-accel") ||
                    $.Nj(a, "anychart-menuitem-mnemonic-separator"))
                  ? ""
                  : $.nf(a);
              }).join("")),
              $.nc(a))
        ...
        $.g.EA = function (a) {
          return a.keyCode == this.PN && this.Us(a)
            ? !0
            : g8.u.EA.call(this, a);
        };
        $.g.yfa = function () {
        ...
        h8.prototype.tE = function (a, b) {
          this.b() && $.n(this.getParent().Ka)
            ? h8.u.tE.call(this, this.getParent().P, b)
            : h8.u.tE.call(this, a, b);
        };
        $.ja(i8);
        $.g = i8.prototype;
        $.g.Ac = function (a) {
        ...
        $.g.Gg = function () {
          ...
          this.Ji(this.hj, !0);
          $.Fy(this)
            .va(this, "enter", this.zH)
            .va(this, "highlight", this.Mfa)
            .va(this, "unhighlight", this.Nfa)
            .va(this, "open", this.sga)
            .va(this, "close", this.Lfa)
            .va(a, $.DD.kF, this.Rj)
            .va($.ve(a), [$.DD.lF, $.DD.jF], this.ega)
            .va(
              a,
              [
                $.DD.kF,
        ...
        $.g.Mfa = function (a) {
          ...
          if (-1 < b && b != this.tl) {
            ...
            this.bm &&
              c != this.bm &&
              ($.nD(c, 64) ? c.Bl(!0) : this.bm.Bl(!1));
          }
          b = this.Ya();
          null != a.target.Ya() &&
            $.By(b, "activedescendant", a.target.Ya().id);
        };
        $.g.Nfa = function (a) {
        ...
        $.g.sga = function (a) {
          (a = a.target) &&
            a != this.bm &&
            a.getParent() == this &&
            (this.bm && this.bm.Bl(!1), (this.bm = a));
        };
        $.g.Lfa = function (a) {
        ...
        $.g.xU = function (a) {
          var b = p8(this);
          if (
            (b && "function" == typeof b.no && b.no(a)) ||
            (this.bm &&
              this.bm != b &&
              "function" == typeof this.bm.no &&
              this.bm.no(a))
          )
            return !0;
          ...
          switch (a.keyCode) {
            ...
            case 38:
              ...
              break;
            case 37:
              if (this.vh == k8) $.Gy(this) ? s8(this) : t8(this);
              else return !1;
              break;
            case 40:
              ...
              break;
            case 39:
              if (this.vh == k8) $.Gy(this) ? t8(this) : s8(this);
              else return !1;
              break;
            default:
              return !1;
        ...
        $.g.Dg = function (a, b, c) {
          ...
          -1 == a && (a = $.Hy(this));
          a == this.tl
            ? (this.tl = Math.min($.Hy(this) - 1, b))
            : a > this.tl && b <= this.tl
            ? this.tl++
            : a < this.tl && b > this.tl && this.tl--;
        };
        ...
        $.g.Ji = function (a, b) {
          if (b || (this.hj != a && this.dispatchEvent(a ? "show" : "hide"))) {
            ...
            c &&
              ($.Rf(c, a),
              this.iD && j8(n8(this), this.DA && this.hj),
        ...
        $.g.ol = function (a) {
          for (
            var b = this.aw,
              c = $.De(this.f.b, "DIV", b.zD() + "-content", a),
              d = c.length,
              e = 0;
            e < d;
            e++
          ...
          b ||
            this.Oj(function (c) {
              !b &&
                c.yfa &&
                c.PN == a.keyCode &&
                (this.isEnabled() && this.Vn(this.Jf(c)), (b = c.no(a)));
            }, this);
          return b;
        };
        $.g.Vn = function (a) {
        ...
        G8.prototype.b = function (a, b, c, d) {
          ...
          if (e & 496) {
            ...
            e & 496 &&
              ((f = H8(e, f)),
              (b = H8(e, b)),
              D8(this.element, f, a, b, null, c, this.o, d, this.D));
          }
        };
        $.H(I8, c8);
        $.ja(I8);
        ...
        $.g.Bh = function () {
          ...
          this.Ul &&
            (L8(this, this.Ul, !1),
            this.WM || (this.Ul.Bh(), $.Ye(this.Ul.Ya())));
          J8.u.Bh.call(this);
        };
        $.g.R = function () {
        ...
        $.g.Bh = function () {
          ...
          this.Jl &&
            (Q8(this, this.Jl, !1),
            this.MK || (this.Jl.Bh(), $.Ye(this.Jl.Ya())));
          O8.u.Bh.call(this);
        };
        $.g.R = function () {
          this.b = null;
        ...
        $.g.BU = function (a, b, c, d, e) {
          ...
          f &&
            ...
            this.wf && this.V_(b),
            (a = $.qa(this.Nia, a)),
            this.Ya() && $.Fy(this).va(this.Ya(), "keydown", a));
        };
        $.g.Nia = function (a, b) {
        ...
        $.g.yH = function (a) {
          this.iM &&
            (this.pa && this.pa.Ua().Kc(),
            (this.lL = a.target),
            Eta(this, a, this.lL),
            $.B(this.items()) &&
              !$.Nc(this.items()) &&
              ($.D(a.getOriginalEvent)
                ? a.getOriginalEvent().preventDefault()
                : a.preventDefault(),
              this.Aj && $.D(this.Aj.getType) && "map" == this.Aj.getType()
        ...
        $.g.BU = function (a, b) {
          a &&
            ...
            ((this.K = !0),
            $.B(a) && $.D(a.listen)
              ? ((this.Aj = a), this.Aj.listen("contextmenu", this.yH, b, this))
              : $.Fy(this).va(a, "contextmenu", this.yH, b));
          return this;
        };
        $.g.CU = function (a, b) {
          this.K &&
            (null != this.Aj && $.D(this.Aj.unlisten)
              ? (this.K = !this.Aj.unlisten("contextmenu", this.yH, b, this))
              : $.de(a, "contextmenu", this.yH, b, this) &&
                ($.Fy(this).fc(a, "contextmenu", this.yH, b), (this.K = !1)),
            this.K || this.Kc());
          return this;
        };
        $.g.show = function (a, b) {
          if ((this.na && !$.Nc(this.items())) || Eta(this, null, this.Aj)) {
            ...
            for (this.wf || this.Rd(this.ba); this.o && 0 != this.o.length; )
        ...
        $.g.U = function (a) {
          ...
          if ((a = a.extraClassNames))
            for (var b = 0, c = a.length; b < c; b++) this.I_(a[b]);
        };
        var I9 = V8.prototype;
        ...
        $.g.nL = function (a, b) {
          return b.Ac(
            "DIV",
            "anychart-inline-block " + (this.Fh() + "-outer-box"),
            b.Ac(
              "DIV",
              "anychart-inline-block " + (this.Fh() + "-inner-box"),
              a
            )
          );
        };
        ...
        $.g.Wk = function (a, b) {
          ...
          a: {
            ...
            if (
              c &&
              $.Nj(c, d) &&
              ((c = a.f.S1(c)), (d = this.Fh() + "-inner-box"), c && $.Nj(c, d))
            ) {
              c = !0;
              break a;
            }
        ...
        $.g.nL = function (a, b) {
          return Y8.u.nL.call(
            ...
            [
              b.Ac(
                "DIV",
                "anychart-inline-block " + (this.Fh() + "-caption"),
                a
              ),
              this.C0(b),
            ],
        ...
        $.g.C0 = function (a) {
          return a.Ac(
            "DIV",
            "anychart-inline-block " + (this.Fh() + "-dropdown"),
            " "
          );
        };
        $.g.Fh = function () {
        ...
        $.g.Rj = function (a) {
          b9.u.Rj.call(this, a);
          this.uq() &&
            (this.Bl(!$.oD(this, 64), a),
            this.b && (this.b.uu = $.oD(this, 64)));
        };
        $.g.tr = function (a) {
          b9.u.tr.call(this, a);
        ...
        $.g.Bl = function (a, b) {
          ...
          if (this.b && $.oD(this, 64) == a) {
            ...
            if (!this.md) {
              ...
              this.pN && d.call(c, this.b, "blur", this.qga);
        ...
        f9.prototype.Ac = function (a) {
          return a.f.Ac(
            "DIV",
            $.qD(this, a).join(" ") + " anychart-inline-block",
            " "
          );
        };
        ...
        k9.prototype.O = function (a) {
          return $.n(a)
            ? ((a = $.Ce(window.document, a)),
              this.Jc != a && (this.Bh(), (this.Jc = a), this.W()),
              this)
            : this.Jc;
        };
        ...
        $.g.Ufa = function (a) {
          ...
          if ("print" == b)
            ...
            a
              ? ((d = a[b]), $.D(d) ? d.apply(a, c) : $.kl(14, null, [b]))
              : $.kl(15);
        };
        $.g.N4 = function (a) {
          if ($.n(a)) {
        ...
        $.g.lfa = function (a) {
          return $.n(a)
            ? (this.na != a &&
                ((this.na = a),
                this.ba && $.ef(this.ba, $.iq.format.getMessage(this.na))),
              this)
            : this.na;
        };
        $.g.dla = function (a) {
          return $.n(a)
            ? (this.Ia != a &&
                ((this.Ia = a),
                this.P && $.ef(this.P, $.iq.format.getMessage(this.Ia))),
              this)
            : this.Ia;
        };
        $.g.Rd = function (a) {
        ...
        $.g.Gg = function () {
          ...
          if (this.b) {
            ...
            this.aa ||
              ((this.aa = new $.Np(this.i.Ya())),
              a.va(this.aa, "key", this.fO));
            this.ea ||
              ((this.ea = new $.Np(this.K.Ya())),
              a.va(this.ea, "key", this.fO));
          }
        };
        $.g.FW = function () {
          var a = this.i.vj(),
        ...
        $.g.fO = function (a) {
          if (13 == a.keyCode) {
            ...
            a: {
              var c = (b = 0);
              if (Pta(a)) (b = a.selectionStart), (c = -1);
              else if ($.id && !$.dd("9")) {
        ...
        $.g.R = function () {
          ...
          this.aa &&
            ($.Fy(this).fc(this.aa, "key", this.fO),
            this.aa.ld(),
            (this.aa = null));
          this.ea &&
            ($.Fy(this).fc(this.ea, "key", this.fO),
            this.ea.ld(),
            (this.ea = null));
          u9.u.R.call(this);
        };
        ...
        $.g.Gla = function (a) {
          return $.n(a)
            ? (this.P != a &&
                ((this.P = a),
                this.K && $.ef(this.K, $.iq.format.getMessage(this.P))),
              this)
            : this.P;
        };
        $.g.Uca = function (a) {
        ...
        $.g.Vca = function (a) {
          var b = a.target.dh,
            c = $.Ak($.LE, b.type, $.n(null) ? null : "max");
          "unit" == c
            ...
            : ((c = $.iq.format.parseDateTime(b.startDate)),
              (b = $.iq.format.parseDateTime(b.endDate)),
        ...
        $.g.Rd = function (a) {
          ...
          var b;
          (b = Zta(a)) ||
            (b = (b = a) && $.D(b.getType) && "timeline" == b.getType());
