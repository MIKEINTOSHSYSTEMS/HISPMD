...
<body>
    ...
    <form method="GET" action="">
        ...
        <select id="status" name="status" onchange="this.form.submit()">
            ...
            <?php foreach ($status as $statusItem): ?>
                <option value="<?php echo htmlspecialchars($statusItem['id']); ?>" <?php if ($filters['status'] == $statusItem['code']) echo 'selected'; ?>>
        ...
        <select id="region" name="region" onchange="updateZones()" onchange="this.form.submit()">
            <option value="">All</option>
        ...
        <select id="zone" name="zone" onchange="updateWoredas()"onchange="this.form.submit()">
            <option value="">All</option>
        </select>

        <label for="woreda">Woreda:</label>
        <select id="woreda" name="woreda" onchange="this.form.submit()">
            <option value="">All</option>
        </select>
    </form>
    ...
    <table>
        ...
        <?php endif; ?>
        <span>Page <?php echo $pageNumber; ?> of <?php echo $totalPages; ?></span>
