    ...
    <nav class="navbar navbar-inverse">
      <div class="container-fluid">
        <div class="navbar-header">
          <a href="#" class="navbar-brand" id="sidebar-toggle">  <i class="fa fa-bars">   Data Visualizer</i>  </a>
        </div>
      </div>
    </nav>
  </div>
...
<br>
    ...
    <div id="main-content">
        ...
        <div id="help" class="section" style="display:none;">
            <h2>Help</h2>
            <p>Help and related articles will be found here on how you can create filter export and customize charts and data preferences here.</p>
        ...
        <div id="about" class="section" style="display:none;">
            ...
            <br>
            <h6>
HISPMDCharts - JavaScript Charts designed to be embedded and integrated, v8.10.0.1933
        </h6>
        </div>
