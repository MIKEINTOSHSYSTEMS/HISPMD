...
function populateFilters() {
    ...
    populateDropdown("periodType", [
        ...new Set(rawData.map((item) => item["Period Type"])),
    ]);
    ...
    populateDropdown("period", [
        ...new Set(rawData.map((item) => item["Period"]))
    ].sort((a, b) => a - b));
...
function applyFilters() {
    ...
    filteredData = rawData.filter(
        ...
        (periodType === "" || item["Facility Type"] === periodType) &&
