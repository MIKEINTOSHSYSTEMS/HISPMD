...
$url = "https://viz.hispmd.merqconsultancy.org/api/card/93/query/json";
...
if ($response === false) {
    ...
    $output = [
        "name" => "Reporting completeness (Representative) ARM report by Region",
        "data" => [],
        "chartType" => "area",
        "defaults" => [
            [
            ...
            [
                ...
                "value" => "Reporting completeness (Representative) ARM report"
            ]
        ]
    ];
