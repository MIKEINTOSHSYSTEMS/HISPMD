...
chartEditor.model.ChartTypes = (function() {
  ...
  types[chartEditor.enums.ChartType.LINE] = {
    'value': 'line',
    'name': 'Line',
    'icon': 'line-chart.svg', // 'http://www.anychart.com/_design/img/upload/charts/types/'
...
chartEditor.model.Base.prototype.loadLocales_ = function(locales) {
  ...
  var localeUrl = 'https://cdn.anychart.com/releases/latest/locales/' + locale + '.js';
  var self = this;
