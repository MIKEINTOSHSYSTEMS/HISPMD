...
chartEditor.ui.exportTabs.SourceCode = function (model, opt_domHelper) {
  chartEditor.ui.exportTabs.SourceCode.base(
    this,
    "constructor",
    model,
    "Source Code",
...
goog.inherits(
  chartEditor.ui.exportTabs.SourceCode,
  chartEditor.ui.exportTabs.Scripts
);
...
chartEditor.ui.exportTabs.SourceCode.prototype.onChartDraw = function (evt) {
  ...
  var chartCode = model.indentCode(
    model.getChartAsJsCode({
  ...
  if (this.preEl) dom.removeNode(this.preEl);

  this.codeEl = dom.createDom(
  ...
  var wrapperEl = dom.getAncestorByClass(
    this.preEl,
    "anychart-ce-tabs-tab-content"
  );
  if (wrapperEl) {
